...
class Review(BaseModel):
    ...
    sentiment: Literal["positive", "negative", "neutral"] = Field(description="sentiment of the review either positive or negative or neutral")
    pros: Optional[list[str]] = Field(description="Write the pros of the review")
    cons: Optional[list[str]] = Field(description="Write the cons of the review")
